...
export const darkTheme = {
  '--background-primary': designTokens.colors.dark.backgroundPrimary,
  '--background-secondary': designTokens.colors.dark.backgroundSecondary,
  '--panel-background': designTokens.colors.dark.panelBackground,
  '--card-background': designTokens.colors.dark.cardBackground,
