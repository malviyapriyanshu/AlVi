...
export const lightTheme = {
  '--background-primary': designTokens.colors.light.backgroundPrimary,
  '--background-secondary': designTokens.colors.light.backgroundSecondary,
  '--panel-background': designTokens.colors.light.panelBackground,
  '--card-background': designTokens.colors.light.cardBackground,
