...
export const ArrayBar: React.FC<ArrayBarProps> = ({ value, maxValue, state, pointers }) => {
  ...
  const colors = {
    ...
    comparing: 'bg-yellow-400 shadow-[0_0_15px_rgba(250,204,21,0.5)]',
    swap: 'bg-rose-500 shadow-[0_0_15px_rgba(244,63,94,0.5)]',
    found: 'bg-orange-500 shadow-[0_0_20px_rgba(249,115,22,0.6)] animate-pulse',
    found_result: 'bg-orange-500 shadow-[0_0_20px_rgba(249,115,22,0.6)] animate-pulse',
    sorted: 'bg-emerald-500',
    discarded: 'bg-slate-700 opacity-40',
    overwrite: 'bg-purple-500 shadow-[0_0_15px_rgba(168,85,247,0.5)]',
  };

  return (
    <div className="relative flex-1 h-full flex flex-col items-center group transition-all duration-300 justify-end">
      <div 
